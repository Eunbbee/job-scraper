        ...
        for keyword in self.keywords:
            ...
            for job in jobs:
                ...
                company_name = job.find(
                    "span", class_="CompanyNameWithLocationPeriod_CompanyNameWithLocationPeriod__company__ByVLu wds-nkj4w6").text
                reward = job.find("span", class_="JobCard_reward__oCSIQ").text
                location = job.find(
                    "span", class_="CompanyNameWithLocationPeriod_CompanyNameWithLocationPeriod__location__4_w0l wds-nkj4w6").text
